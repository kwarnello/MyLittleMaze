...
public class CultistShoulders extends ArmorBase {

	public CultistShoulders(ItemTypes itemType) {
		super(itemType);

		name = "Cultist shoulders";
		path = "res/armors/sets/cultistSet/shoulders.png";
